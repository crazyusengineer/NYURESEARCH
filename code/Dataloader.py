...
class ThreeV2I_BC_data(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        View = self.convert_input(input_dic, "/0.png")
        Ans_1 = self.convert_input(input_dic, "/1.png")
        Ans_2 = self.convert_input(input_dic, "/2.png")
        Ans_3 = self.convert_input(input_dic, "/3.png")
        Ans_4 = self.convert_input(input_dic, "/4.png")
